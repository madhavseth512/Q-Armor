...
# Columns dropped as dead/constant/redundant by EDA (CHANGE 2):
#   Drate    — zero across the entire dataset (degenerate)
#   Number   — constant 9.5 (aggregation artifact)
#   Weight   — constant 141.55 (aggregation artifact)
#   IAT      — near-constant across all classes (no discriminative value)
#   Std      — 0.76-correlated with AVG (redundant; keep AVG, drop Std)
DROP_COLUMNS: list[str] = ["Drate", "Number", "Weight", "IAT", "Std"]
